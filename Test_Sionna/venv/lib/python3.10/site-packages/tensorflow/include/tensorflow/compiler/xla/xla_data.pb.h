...
class OpMetadata :
 ...
 public:
  ...
  // string replaced_op = 11;
  void clear_replaced_op();
  const std::string& replaced_op() const;
  void set_replaced_op(const std::string& value);
  void set_replaced_op(std::string&& value);
  void set_replaced_op(const char* value);
  void set_replaced_op(const char* value, size_t size);
  std::string* mutable_replaced_op();
  std::string* release_replaced_op();
  void set_allocated_replaced_op(std::string* replaced_op);
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_replaced_op();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_replaced_op(
      std::string* replaced_op);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr replaced_op_;
...
// string replaced_op = 11;
inline void OpMetadata::clear_replaced_op() {
  replaced_op_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline const std::string& OpMetadata::replaced_op() const {
  // @@protoc_insertion_point(field_get:xla.OpMetadata.replaced_op)
  return replaced_op_.Get();
}
inline void OpMetadata::set_replaced_op(const std::string& value) {
  
  replaced_op_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set:xla.OpMetadata.replaced_op)
}
inline void OpMetadata::set_replaced_op(std::string&& value) {
  
  replaced_op_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:xla.OpMetadata.replaced_op)
}
inline void OpMetadata::set_replaced_op(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  replaced_op_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:xla.OpMetadata.replaced_op)
}
inline void OpMetadata::set_replaced_op(const char* value,
    size_t size) {
  
  replaced_op_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:xla.OpMetadata.replaced_op)
}
inline std::string* OpMetadata::mutable_replaced_op() {
  
  // @@protoc_insertion_point(field_mutable:xla.OpMetadata.replaced_op)
  return replaced_op_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline std::string* OpMetadata::release_replaced_op() {
  // @@protoc_insertion_point(field_release:xla.OpMetadata.replaced_op)
  
  return replaced_op_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
inline void OpMetadata::set_allocated_replaced_op(std::string* replaced_op) {
  if (replaced_op != nullptr) {
    
  } else {
    
  }
  replaced_op_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), replaced_op,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:xla.OpMetadata.replaced_op)
}
inline std::string* OpMetadata::unsafe_arena_release_replaced_op() {
  // @@protoc_insertion_point(field_unsafe_arena_release:xla.OpMetadata.replaced_op)
  GOOGLE_DCHECK(GetArenaNoVirtual() != nullptr);
  
  return replaced_op_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArenaNoVirtual());
}
inline void OpMetadata::unsafe_arena_set_allocated_replaced_op(
    std::string* replaced_op) {
  GOOGLE_DCHECK(GetArenaNoVirtual() != nullptr);
  if (replaced_op != nullptr) {
  ...
  replaced_op_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      replaced_op, GetArenaNoVirtual());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:xla.OpMetadata.replaced_op)
}
